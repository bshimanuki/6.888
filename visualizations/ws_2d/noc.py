    ...
    def tick(self):
        ...
        if self.rd_chn.valid():
            ...
            for y in range(ymin, ymax):
                vacancy = vacancy and self.wr_chns[y][self.curr_filter].vacancy() # TODO?????

            # If vacancy, then all self.wr_chns[y][self.curr_filter].vacancy == True
            if vacancy:
    ...
    def tick(self):
        ...
        if valid:
            ...
            if target_chn.vacancy():
                # print "psum_to_glb: ", self.iteration, self.psum_idx, xmin, xmax
